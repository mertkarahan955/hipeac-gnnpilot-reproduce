...
torch.ops.load_library("../build/libgmm.so")
...
info = torch.ops.gmmlib.preprocessing(rowptr, indices, 1)
perf_time_end()

perf_time_start("warmup")
torch.ops.gmmlib.gmm_kernel_0(info, rowptr, indices, fd, fd2, f, fo, p, mu, diag, e)
perf_time_end()
...
for i in range(32):
    ...
    func_name = "torch.ops.gmmlib.gmm_kernel_{:d}(info, rowptr, indices, fd, fd2, f, fo, p, mu, diag, e)".format(i)
