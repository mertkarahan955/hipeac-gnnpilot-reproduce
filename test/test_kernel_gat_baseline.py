...
if (baseline_type == 'UGCG'):
    ugcg_model = ugcg_model_init("GAT", in_dim, gcn_hidden, out_dim, relu_l=0.2, paras=paras).to(device)
...
if (baseline_type == 'UGCG'):
    out_ugcg, _ = ugcg_model_run(ugcg_model, graph_csr, f, device)
elif (baseline_type == 'PCKGNN'):
...
if (baseline_type == 'UGCG'):
    out_ugcg, layer_time = ugcg_model_run(ugcg_model, graph_csr, f, device)
elif (baseline_type == 'PCKGNN'):
